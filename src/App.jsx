...
const T={
  bg:"#1A0F2E",
  bgGradient:"linear-gradient(135deg, #1A0F2E 0%, #2D1B69 25%, #402079 50%, #552088 75%, #1A0F2E 100%)",
  card:"rgba(147, 112, 219, 0.08)",
  cardGlass:"rgba(255, 255, 255, 0.06)",
  cardGlassHover:"rgba(147, 112, 219, 0.12)",
  b:"rgba(255, 255, 255, 0.1)",
  acc:"#8B7AB8",
  accLight:"#A896D1",
  accGlow:"rgba(139, 122, 184, 0.3)",
  cy:"#7393B3",
  cyLight:"#8FA7C3",
  cyGlow:"rgba(115, 147, 179, 0.25)",
  sec:"#B8B8D0",
  ok:"#6B8E6B",
  okGlow:"rgba(107, 142, 107, 0.25)",
  ng:"#B85C5C",
  ngGlow:"rgba(184, 92, 92, 0.25)",
  go:"#C9A95C",
  goGlow:"rgba(201, 169, 92, 0.25)",
  pu:"#9B7BB8",
  puGlow:"rgba(155, 123, 184, 0.25)",
  tx:"#F5F5F5",
  txDim:"#D0D0D0",
  stripe:"#8B7AB8",
  neon:"#B8B8D0",
  ...
  neonGreen:"#A0D0A0",
  neonPurple:"#C8A8E8",
  diamond:"rgba(215, 215, 235, 0.5)",
  diamondGlow:"rgba(215, 215, 235, 0.7)"
};
